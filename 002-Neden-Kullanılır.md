...
- Özellikle büyük sunucularda Postfix, Sendmail, OpenSMTPD gibi mail sunucuları kullanıcıları LDAP kullanılır,örneğin bir kullanıcıyı bu 3 sistem için tek tek oluşturmak yerine LDAP'ta bir kere tanımlamak.
